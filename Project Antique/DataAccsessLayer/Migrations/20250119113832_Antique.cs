...
{
    /// <inheritdoc />
    public partial class Antique : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmallPrice = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LargePrice = table.Column<string>(type: "nvarchar(max)", nullable: true),
